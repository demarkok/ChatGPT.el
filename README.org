...
(use-package chatgpt
  :straight (:host github :repo "demarkok/ChatGPT.el" :files ("dist" "*.el"))
  :init
  (require 'python)
...
(use-package chatgpt
  :quelpa ((chatgpt :fetcher git :url "https://github.com/demarkok/ChatGPT.el.git") :upgrade t)
  :init
  (require 'python)
...
#+begin_src emacs-lisp
(package! chatgpt
  :recipe (:host github :repo "demarkok/ChatGPT.el" :files ("dist" "*.el")))
#+end_src
